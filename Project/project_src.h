#ifndef PROJECT_SRC_H
#define PROJECT_SRC_H
...
/*
class CEmbodiedEntity : public CBuzzLoopFunctions {

public:
  CEmbodiedEntity() {}
  ~CEmbodiedEntity() {}

  void TrackCoordinates(buzzvm_t vm);
  void Init(TConfigurationNode& t_tree);
  void RegisterFunctions(buzzvm_t vm);
